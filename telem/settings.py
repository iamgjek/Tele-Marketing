"""
Django settings for telem project.
...
SECRET_KEY = 'django-insecure-=kyxrivki*_)a^=klghqe9tbrsza97zd)vr@ci4u2hx#wvuy0!'
...
WSGI_APPLICATION = 'telem.wsgi.application'
...
DATABASE_ROUTERS = ['telem.db_router.DatabaseAppsRouter']
